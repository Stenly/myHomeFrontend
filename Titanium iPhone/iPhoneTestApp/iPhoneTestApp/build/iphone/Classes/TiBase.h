...
// in simulator we redefine to format for iPhoneTestApp3 Developer console
...
{\
	NSString * exceptionName = [@"org.iphonetestapp3." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.iphonetestapp3";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIiPhoneTestApp3NativeItemNone = -1, 
	UIiPhoneTestApp3NativeItemSpinner = -2,
	UIiPhoneTestApp3NativeItemProgressBar = -3,
	
	UIiPhoneTestApp3NativeItemSlider = -4,
	UIiPhoneTestApp3NativeItemSwitch = -5,
	UIiPhoneTestApp3NativeItemMultiButton = -6,
	UIiPhoneTestApp3NativeItemSegmented = -7,
	
	UIiPhoneTestApp3NativeItemTextView = -8,
	UIiPhoneTestApp3NativeItemTextField = -9,
	UIiPhoneTestApp3NativeItemSearchBar = -10,
	
	UIiPhoneTestApp3NativeItemPicker = -11,
	UIiPhoneTestApp3NativeItemDatePicker = -12,
	
	UIiPhoneTestApp3NativeItemInfoLight = -13,
	UIiPhoneTestApp3NativeItemInfoDark = -14,
	
	UIiPhoneTestApp3NativeItemDisclosure = -15,
	
	UIiPhoneTestApp3NativeItemContactAdd = -16
};
