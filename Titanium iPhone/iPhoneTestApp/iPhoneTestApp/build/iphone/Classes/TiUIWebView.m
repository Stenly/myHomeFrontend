...
NSString * const kiPhoneTestApp3Javascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_iphonetestapp3Injection
{
	...
	[html appendString:kiPhoneTestApp3Javascript];
...
{
	// attempt to make well-formed HTML and inject in our iPhoneTestApp3 bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _iphonetestapp3Injection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to iPhoneTestApp3 support.",url);
				}
			}
